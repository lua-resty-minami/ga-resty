...
local base = require "resty.lua_resty_core.base"
local bit = require "bit"
require "resty.lua_resty_core.time"  -- for ngx.now used by resty.lrucache
local lrucache = require "resty.lua_resty_lrucache.lrucache"
